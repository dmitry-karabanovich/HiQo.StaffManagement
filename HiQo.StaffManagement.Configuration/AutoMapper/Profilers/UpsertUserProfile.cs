    ...
    public class UpsertUserProfile : Profile
    {
        public UpsertUserProfile()
        {
            CreateMap<UserDto, UpsertUser>()
                ...
                .ForMember(upsertUser => upsertUser.PositionLevelId,
                    cfg => cfg.MapFrom(user => user.PositionLevelDtoId))
                ...
                .ForMember(user => user.DateBirth,
                    cfg => cfg.MapFrom(upsertUser =>upsertUser.DateOfBirth.AsDateTime()));
        }
    }
}
